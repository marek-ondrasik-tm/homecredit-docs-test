...
3. Calculator not working, displaying message "Something went wrong":
  ...
  * CZ: ApiKey value: calculator_test_key and URL https://apicz-test.homecredit.net/verdun-train/public/v1/calculator/
  * SK: ApiKey value: calculator_test_key_sk and URL https://apisk-test.homecredit.net/verdun-train/public/v1/calculator/
