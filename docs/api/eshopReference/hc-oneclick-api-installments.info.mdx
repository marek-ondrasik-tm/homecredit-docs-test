...
In order to use Home Credit's javascript widget as an installment calculator, your e-shop back-end has to be configured properly. How to do it is currently described in [our on-line repository](/docs/documentation/widgets/install) (currently written in Czech).
