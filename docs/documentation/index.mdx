...
| **Widget** | JavaScript widget embedded in your e-shop (download at [github.com/homecreditcz](https://github.com/homecreditcz)). *Only for certified intermediaries under Act 257/2016 Sb.* | [JavaScript widget integration](/docs/documentation/widgets/install) |
