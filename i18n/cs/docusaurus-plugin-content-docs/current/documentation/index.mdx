...
|----------|--------|--------|
| **API** | Vlastní design, my vracíme hodnoty. *Pouze pro certifikované zprostředkovatele dle zákona 257/2016 Sb.* | [Zdroje pro výpočet splátek](/docs/api/Reference/installments-calculator-resources) |
| **Widget** | JavaScriptový widget do stránek vašeho e-shopu (stáhněte na [github.com/homecreditcz](https://github.com/homecreditcz)). *Pouze pro certifikované zprostředkovatele dle zákona 257/2016 Sb.* | [JavaScript widget integration](/docs/documentation/widgets/install) |
...
- **Autentizace:** [Login partner](/docs/api/Reference/login-partner) (`authentication/v1/partner`)
- **Vytvoření žádosti:** [Create application](/docs/api/Reference/create-application) (`financing/v1/applications`)
...
| Varianta | Popis | Odkaz |
|----------|--------|--------|
| **Notifikační endpoint** | Zasíláme na vaše API při každé změně žádosti. | [Application notification](/docs/api/Reference/application-notification) |
| **Webservice** | Přes API odpovíme na váš dotaz aktuálním stavem žádosti („GET applicationDetail“). | [Get application](/docs/api/Reference/get-application) |
...
| Varianta | Popis | Odkaz |
|----------|--------|--------|
| **Mark as shipped** | Potvrzení odeslání zboží přes API. | [Mark order as shipped](/docs/api/Reference/mark-order-as-shipped) (PUT send) |
| **Mark as delivered** | Potvrzení o doručení zboží klientovi přes API. | [Mark order as delivered](/docs/api/Reference/mark-order-as-delivered) (PUT deliver) |
